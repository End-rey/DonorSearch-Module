...
export const DonationRefCard = () => {
  return (
    <div className='w-[240px] rounded-2xl bg-white p-4'>
      <div className='flex w-full justify-between'>
        <p className='text-sm font-normal opacity-50'>date</p>
        <MoreVertical />
      </div>
      <p className='line-clamp-2 font-bold text-dark opacity-80'>
        ФГБОУВО «Первый Санкт-Петербургский что-то там"
      </p>
      <p className='line-clamp-1 text-sm font-normal text-dark opacity-50'>
      ...
      <div className='mt-2 flex flex-col items-start'>
        <p className='text-sm font-normal text-dark opacity-50'>Безвозмездно</p>
        <div className='flex items-center'>
          <Dot color='#c2c2c2' />
          <p className='text-sm font-normal text-dark'>Без справки</p>
        </div>
      </div>
    </div>
  );
